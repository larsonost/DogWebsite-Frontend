        ...
        <div className="col-8">
            <div className="container">
                <div className="login-form border rounded p-4 bg-light">
                    {/* You don't necessarily need the <form> tag if you are handling the submission yourself with JavaScript */}
                    <form>
                        <div className="mb-3">
                    ...
                    {/* Additional links or options can be added below, like registration */}
                    <hr />
